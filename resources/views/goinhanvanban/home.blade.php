                  ...
                  <tr>
                    ...
                    <td>
                      <form action="{{ route('delete-van-ban', ['id' => $vb->id]) }}" method="POST">
                        ...
                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="##">Edit</button>
                        <button onclick="return confirm('Bạn muốn văn bản này?')" type="submit" class="btn btn-sm btn-danger">Delete</button>
                      </form>
                    </td>
                  </tr>
